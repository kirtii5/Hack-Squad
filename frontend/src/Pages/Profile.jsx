...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-black text-white pt-24 px-6 relative overflow-hidden pb-30">
      ...
      {/* Profile Container */}
      <div className="relative z-10 max-w-6xl mx-auto rounded-3xl bg-gradient-to-br from-gray-800 via-gray-900 to-black shadow-2xl border border-gray-700 p-10">
        
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-center mb-10">
          <h2 className="text-4xl font-extrabold tracking-wide text-purple-300 mb-4 md:mb-0">
            User Profile
          </h2>
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <button
              className="bg-pink-600 hover:bg-pink-500 transition px-5 py-2 rounded-xl font-medium"
              onClick={() => navigate('/')}
            >
              Home
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                type="text"
                className="w-full px-5 py-3 bg-gray-700 text-white border border-gray-600 rounded-xl placeholder-gray-400"
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {skillsOffered.map((skill, i) => (
                  <span
                    key={i}
                    className="flex items-center bg-blue-900 px-4 py-1.5 rounded-full text-sm border border-blue-400"
                  >
                    {skill}
                    <button
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {skillsWanted.map((skill, i) => (
                  <span
                    key={i}
                    className="flex items-center bg-purple-900 px-4 py-1.5 rounded-full text-sm border border-purple-400"
                  >
                    {skill}
                    <button
            ...
            {/* Visibility */}
            <div>
              <label className="text-sm text-gray-300 mb-1 block">Profile Visibility</label>
